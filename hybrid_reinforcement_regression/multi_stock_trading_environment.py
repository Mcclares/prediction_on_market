...
class MultiStockTradingEnvironment(gym.Env):
    def __init__(self, data, predictions, initial_balance=1000):
    ...
    def _get_observation(self):
        ...
        predicted_prices = self.predictions[self.current_step]
        return np.concatenate((current_prices, predicted_prices))
